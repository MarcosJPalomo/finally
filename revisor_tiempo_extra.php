...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($accion == 'aprobar' || $accion == 'rechazar') {
        ...
        if ($update_stmt->execute()) {
            ...
            $accion_log = "Revisión de solicitud de tiempo extra " . $estado;
            $tabla = "tiempo_extra";
...
// Obtener todas las solicitudes de tiempo extra para el revisor
...
$query = "SELECT te.*, e.nombre, e.puesto, 
          ...
          ORDER BY te.estado_revisor = 'pendiente' DESC, te.fecha_solicitud DESC";
...
<head>
    ...
    <title>Revisión de Tiempo Extra - Sistema de Gestión de RH</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="revisor_tiempo_extra.php">Revisión de Tiempo Extra</a>
                    </li>
                </ul>
    ...
    <div class="container mt-4">
        <h1>Revisión de Solicitudes de Tiempo Extra</h1>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($solicitud['estado_revisor'] == 'pendiente'): ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalRevisarLabel<?php echo $solicitud['id']; ?>">Revisar Solicitud de Tiempo Extra</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="revisor_tiempo_extra.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <h6 class="mb-0">Procesamiento de RH</h6>
                    </div>
                    <div class="card-body">
                        <?php 
                        $badge_class_rh = '';
