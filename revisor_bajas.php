...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($accion == 'aprobar' || $accion == 'rechazar') {
        ...
        if ($update_stmt->execute()) {
            ...
            $accion_log = "Revisión de solicitud de baja " . $estado;
...
<head>
    ...
    <title>Revisión de Bajas - Sistema de Gestión de RH</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="revisor_bajas.php">Revisión de Bajas</a>
                    </li>
                </ul>
    ...
    <div class="container mt-4">
        <h1>Revisión de Solicitudes de Baja</h1>
